...
exports.ListEarnService = void 0;
...
class ListEarnService {
    list({ period, account, created_by }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const earn = yield prisma_1.default.earn.findMany({
                where: {
    ...
    resumUntilPeriod({ period, account, created_by }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const earn = yield prisma_1.default.earn.aggregate({
                _sum: {
                    value: true,
                },
                where: {
    ...
    resume({ period, created_by }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const expense = yield prisma_1.default.earn.groupBy({
                by: ['category_id'],
                _sum: {
                    value: true,
                },
    ...
    execute({ id, date, description, value, category_id, goal_period_id, date_compare, date_ini, date_fim, created_by, account }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const earn = yield prisma_1.default.earn.findMany(query);
            return earn;
        });
    }
}
exports.ListEarnService = ListEarnService;
